...
struct Unsigned256BitIntegerModel {
    ...
    @inlinable
    func compare(to other: Unsigned256BitIntegerModel) -> ComparisonResult {
...
extension Unsigned256BitIntegerModel: Sendable {}
extension Unsigned256BitIntegerModel: Equatable {
    static func == (lhs: Unsigned256BitIntegerModel, rhs: Unsigned256BitIntegerModel) -> Bool {
