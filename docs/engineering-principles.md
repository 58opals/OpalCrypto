...
Opal Crypto is a Swift-first secp256k1 cryptography package with BCH primitives and focused BIP340 and NIP-44 surfaces. The implementation should stay readable, auditable, portable across the supported Apple platform set, and backed by correctness tests before performance claims are trusted.
