...
struct PublicAPICommunicationCiphertextValidator {
    ...
    func communicationBoxesRejectTamperedAuthenticationCodes() throws {
        ...
        let recipientPublicKey = try OpalCrypto.Secp256k1.deriveCompressedPublicKey(from: recipientPrivateKey)
        ...
        do {
            _ = try OpalCrypto.Communication.decrypt(ciphertext, privateKey: recipientPrivateKey)
